...
| :- | :- | :- |
|Participa en equipos multidisciplinarios con eficacia, eficiencia y objetividad, en el marco de un proyecto en soluciones de ingeniería de software.|<p>TB1:</p><p></p><p>- Francis Daniel Mamani Silva:</p><p></p><p>Realización del capítulo 2, realización del landing page de nuestro proyecto, implementación de estilos en el landing page</p><p></p><p>- Ian Macavilca Quispe:</p><p>- Frank Junior Salazar Saldarriaga:</p><p>- Paolo Del Carmen Martines Villanueva:</p><p></p><p>Realización de las User Stories, Technical User Stories, Product Backlog, Domain Driven Software Arquitecture, Software Object-Oriented Design, Database Design, capítulo 5 y desarrollo del landing page</p><p>- Michael Stefano Carmelino Dueñas:</p>|Durante el desarrollo del proyecto, nuestro equipo demostró habilidades de colaboración multidisciplinaria al integrar eficazmente conocimientos y habilidades de diferentes áreas, como desarrollo de software, diseño de interfaces de usuario y gestión de proyectos. Cada miembro del equipo contribuyó de manera eficiente a la consecución de los objetivos establecidos, cumpliendo con las tareas asignadas en los plazos definidos y manteniendo una comunicación abierta y efectiva. Además, se evidenció un enfoque objetivo en la toma de decisiones, priorizando el éxito del proyecto sobre intereses personales o conflictos internos. Estas experiencias fortalecieron la capacidad del equipo para trabajar conjuntamente en proyectos de ingeniería de software, promoviendo un ambiente de colaboración, eficiencia y objetividad.|
