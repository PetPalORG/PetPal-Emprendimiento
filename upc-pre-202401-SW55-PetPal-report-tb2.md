...
| :- | :- | :- |
|Participa en equipos multidisciplinarios con eficacia, eficiencia y objetividad, en el marco de un proyecto en soluciones de ingeniería de software.|<p>**TB1:**</p><p></p><p>- Francis Daniel Mamani Silva:</p><p></p><p>Realización del capítulo 2, realización del landing page de nuestro proyecto, implementación de estilos en el landing page</p><p></p><p>- Ian Macavilca Quispe:</p><p></p><p>Realización del Impact Mapping, capítulo 4 y desarrollo de la landing page</p><p>- Frank Junior Salazar Saldarriaga:</p><p></p><p>Realización del capítulo 1, desarrollo de la landing page, capítulo 4</p>- Paolo Del Carmen Martinez Villanueva:</p><p></p><p>Realización de las User Stories, Technical User Stories, Product Backlog, Domain Driven Software Arquitecture, Software Object-Oriented Design, Database Design, capítulo 5 y desarrollo del landing page</p><p>- Michael Stefano Carmelino Dueñas:</p><p></p><p>Realización del to-be scenario mapping, capítulo 4 y desarrollo de la landing page.</p><p>**TP:**</p><p></p><p>- Francis Daniel Mamani Silva:</p><p></p><p>Realización de las sección de perfil de usuario en la aplicación web y avance del informe</p><p></p><p>- Ian Macavilca Quispe:</p><p></p><p>Realización de la sección artículos en la aplicación web y avance en el informe</p><p>- Frank Junior Salazar Saldarriaga:</p><p></p><p>Realización del Landing Page en la aplicación web y avance en el informe</p>- Paolo Del Carmen Martinez Villanueva:</p><p></p><p>Realización de las secciones perfil de mascota, dieta, citas veterinarias e historial médico en la aplicación web y avance del informe</p><p>- Michael Stefano Carmelino Dueñas:</p><p></p><p>Realización de la sección registro e inicio de sesión en la aplicación web y avance del informe</p>|<p>**TB1:**</p><p></p><p>Durante el desarrollo del proyecto, nuestro equipo demostró habilidades de colaboración multidisciplinaria al integrar eficazmente conocimientos y habilidades de diferentes áreas, como desarrollo de software, diseño de interfaces de usuario y gestión de proyectos. Cada miembro del equipo contribuyó de manera eficiente a la consecución de los objetivos establecidos, cumpliendo con las tareas asignadas en los plazos definidos y manteniendo una comunicación abierta y efectiva. Además, se evidenció un enfoque objetivo en la toma de decisiones, priorizando el éxito del proyecto sobre intereses personales o conflictos internos. Estas experiencias fortalecieron la capacidad del equipo para trabajar conjuntamente en proyectos de ingeniería de software, promoviendo un ambiente de colaboración, eficiencia y objetividad.</p><p></p><p>**TP:**</p><p></p><p>Como conclusión para esta segunda entrega del proyecto, hemos promovido la comunicación oral grupal ya que al ser un trabajo de mayor complejidad, la comunicación ha sido necesaria para apoyarnos entre nosotros en nuestras tareas semanales. Al participar activamente en las llamadas grupales, hemos reconocido los conocimientos que tiene cada integrante. Además, estas interacciones nos han permitido resolver las dudas de cada integrante y compartir nuestros aprendizajes.</p><p></p><p>**TB2:**</p><p></p><p>En esta segunda entrega del proyecto (TB2), centrada en el desarrollo del backend, hemos promovido la colaboración efectiva en equipos multidisciplinarios. La complejidad del trabajo requirió una comunicación constante y eficiente, permitiéndonos apoyarnos mutuamente en nuestras tareas semanales. A través de reuniones grupales, hemos podido reconocer y aprovechar los conocimientos específicos de cada integrante, lo que ha resultado en un trabajo más coordinado y objetivo. Estas interacciones nos han permitido resolver dudas de manera rápida y compartir aprendizajes, mejorando la eficacia y eficiencia de nuestro equipo.|
|Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería.|<p>TB1:</p><p></p><p>- Francis Daniel Mamani Silva:</p><p></p><p>Realización del capítulo 2, realización del landing page de nuestro proyecto, implementación de estilos en el landing page. Además, realicé entrevistas a los usuarios para conocer sus opiniones y recomendaciones acerca del proyecto.</p><p></p><p>- Ian Macavilca Quispe:</p><p></p><p>Me mantuve activo en la participación y comunicación oral en las llamadas grupales, dando ideas de mejora y ayuda tanto para el informe como para la Landing Page. Además, realicé entrevistas a los usuarios para conocer sus opiniones y recomendaciones acerca del proyecto.</p><p>- Frank Junior Salazar Saldarriaga:</p><p></p><p>Para esta entrega comuniqué mis ideas y propuse nuevas soluciones en las llamadas grupales, además de participar activamente en estas. Además, realicé entrevistas a los usuarios para conocer sus opiniones y recomendaciones acerca del proyecto.</p><p>- Paolo Del Carmen Martinez Villanueva:</p><p></p><p>Comuniqué mi idea para la elección del tema de nuestro proyecto durante la primera reunión del grupo y aporté ideas para poder realizar el trabajo de manera correcta. Además, realicé entrevistas a los usuarios para conocer sus opiniones y recomendaciones acerca del proyecto.</p><p>- Michael Stefano Carmelino Dueñas:</p><p></p><p>Participé en las llamadas grupales de cada semana pidiendo opiniones y nuevas ideas de implementación para la Landing Page. Además, realicé entrevistas a los usuarios para conocer sus opiniones y recomendaciones acerca del proyecto.</p><p></p><p>**TP:**</p><p></p><p>- Francis Daniel Mamani Silva:</p><p></p><p>Para esta entrega informé al grupo sobre mis avances en la aplicación web y estuve presente en las llamadas grupales.</p><p></p><p>- Ian Macavilca Quispe:</p><p></p><p>Para esta entrega estuve presente en las llamadas grupales para comunicar mis dudas y avances sobre el desarrollo de la aplicación web.</p><p>- Frank Junior Salazar Saldarriaga:</p><p></p><p>Para esta entrega estuve presente en las llamadas grupales para comunicar mis dudas y avances sobre el desarrollo de la aplicación web.</p><p>- Paolo Del Carmen Martinez Villanueva:</p><p></p><p>Para esta entrega realicé llamadas grupales continuamente para que los integrantes se repartieran tareas semanales y se ayuden entre ellos.</p><p>- Michael Stefano Carmelino Dueñas:</p><p></p><p>En esta entrega colaboré activamente en las llamadas grupales y comuniqué sobre mis avances y correcciones.</p>|<p>TB1:</p><p></p><p>Durante la ejecución del proyecto, nuestro equipo demostró habilidades destacadas en la comunicación escrita objetiva al redactar documentos claros y concisos que transmitían ideas y resultados de manera efectiva. Además, se observó una adaptabilidad impresionante en la comunicación, ya que el equipo pudo ajustar el tono y el nivel de detalle de los documentos según la audiencia, incluyendo tanto a especialistas técnicos como a stakeholders de niveles jerárquicos superiores. La claridad y precisión en la redacción se mantuvieron constantes a lo largo del proyecto, lo que facilitó la comprensión de la información y evitó malentendidos. Estas habilidades de comunicación fortalecieron la colaboración dentro del equipo y contribuyeron al éxito general del proyecto en ingeniería.</p><p></p><p>TP:</p><p></p><p>Como conclusión para esta segunda entrega del proyecto, hemos promovido la comunicación oral grupal ya que al ser un trabajo de mayor complejidad, la comunicación ha sido necesaria para apoyarnos entre nosotros en nuestras tareas semanales. Al participar activamente en las llamadas grupales, hemos reconocido los conocimientos que tiene cada integrante. Además, estas interacciones nos han permitido resolver las dudas de cada integrante y compartir nuestros aprendizajes. </p><p></p><p>**TB2:**</p><p></p><p>  En el marco del desarrollo del backend para esta entrega, hemos puesto un énfasis especial en la comunicación escrita. Nos hemos asegurado de transmitir ideas y resultados de manera clara y objetiva a públicos de diferentes especialidades y niveles jerárquicos. Esta habilidad ha sido crucial para documentar nuestros avances y asegurarnos de que todos los miembros del equipo, así como los interesados externos, comprendan plenamente el estado y los logros del proyecto. La práctica de comunicar de manera precisa y profesional ha fortalecido nuestra capacidad para trabajar de manera efectiva en un entorno multidisciplinario. |
