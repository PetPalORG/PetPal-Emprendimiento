...
| 1.7       |  2024/04/01    | -Ian Macavilca Quispe<br>-Paolo Del Carmen Martinez Villanueva<br>-Michael Stefano Carmelino Dueñas|Elaboración de prototipos de wireframes y mockups  | Completado |
| 1.8       |  2024/04/02    | -Frank Junior Salazar Saldarriaga<br>-Ian Macavilca Quispe|Redacción de style guidelines e information architecture| Completado |
...
| 2.1       |  2024/04/07    |-Ian Macavilca Quispe<br>-Paolo Del Carmen Martinez Villanueva<br>-Michael Stefano Carmelino Dueñas |Rediseño de mockups. Elaboración de wireflows y user-flows| Completado |
...
| :- | :- | :- |
| Participa en equipos multidisciplinarios con eficacia, eficiencia y objetividad, en el marco de un proyecto en soluciones de ingeniería de software. | **TB1:**<br><br>- **Francis Daniel Mamani Silva:**<br>Realización del capítulo 2, realización del landing page de nuestro proyecto, implementación de estilos en el landing page.<br><br>- **Ian Macavilca Quispe:**<br>Realización del Impact Mapping, capítulo 4 y desarrollo de la landing page.<br><br>- **Frank Junior Salazar Saldarriaga:**<br>Realización del capítulo 1, desarrollo de la landing page, capítulo 4.<br><br>- **Paolo Del Carmen Martinez Villanueva:**<br>Realización de las User Stories, Technical User Stories, Product Backlog, Domain Driven Software Architecture, Software Object-Oriented Design, Database Design, capítulo 5 y desarrollo del landing page.<br><br>- **Michael Stefano Carmelino Dueñas:**<br>Realización del to-be scenario mapping, capítulo 4 y desarrollo de la landing page.<br><br>**TP:**<br><br>- **Francis Daniel Mamani Silva:**<br>Realización de las sección de perfil de usuario en la aplicación web y avance del informe.<br><br>- **Ian Macavilca Quispe:**<br>Realización de la sección artículos en la aplicación web y avance en el informe.<br><br>- **Frank Junior Salazar Saldarriaga:**<br>Realización del Landing Page en la aplicación web y avance en el informe.<br><br>- **Paolo Del Carmen Martinez Villanueva:**<br>Realización de las secciones perfil de mascota, dieta, citas veterinarias e historial médico en la aplicación web y avance del informe.<br><br>- **Michael Stefano Carmelino Dueñas:**<br>Realización de la sección registro e inicio de sesión en la aplicación web y avance del informe.<br><br>**TB2:**<br><br>- **Francis Daniel Mamani Silva:**<br>Me enfoqué en implementar los endpoints para la gestión de cuentas de usuario, asegurando la eficiencia y la integridad de los datos. La colaboración con el equipo fue vital para coordinar y resolver problemas.<br><br>- **Ian Macavilca Quispe:**<br>Desarrollé los endpoints para la validación de datos de entrada, mejorando la confiabilidad del sistema. Las reuniones grupales fueron esenciales para resolver problemas y compartir ideas.<br><br>- **Frank Junior Salazar Saldarriaga:**<br>Implementé el sistema de alertas de disponibilidad para mantener informados a los usuarios. La colaboración con mis compañeros ayudó a perfeccionar esta funcionalidad.<br><br>- **Paolo Del Carmen Martinez Villanueva:**<br>Me centré en los endpoints para la gestión de roles y permisos de usuario, asegurando un control adecuado de accesos. La comunicación constante con el equipo facilitó la integración sin problemas.<br><br>- **Michael Stefano Carmelino Dueñas:**<br>Trabajé en el sistema de inicio de sesión seguro, garantizando un acceso confiable y protegido. Las interacciones con el equipo mejoraron la seguridad y el funcionamiento del sistema.<br><br>**TF:**<br><br>- **Francis Daniel Mamani Silva:** <br>Me centré en diseñar y desarrollar la lógica para la autenticación y gestión de sesiones de usuarios. Esto incluyó la implementación de funciones de registro, inicio de sesión y recuperación de contraseñas. La colaboración con el equipo fue fundamental para asegurar que estos componentes fueran seguros y fáciles de usar.<br><br>- **Ian Macavilca Quispe:**<br> Mi principal responsabilidad fue la creación de la arquitectura de la base de datos y la optimización de las consultas para asegurar un rendimiento eficiente. Participé activamente en las revisiones de código y en la resolución de problemas técnicos, lo que contribuyó a mantener la integridad de los datos y mejorar la velocidad del sistema.<br><br>- **Frank Junior Salazar Saldarriaga:**<br> Desarrollé el sistema de notificaciones en tiempo real, permitiendo a los usuarios recibir alertas instantáneas sobre eventos importantes. Este componente fue esencial para mejorar la interacción del usuario con la plataforma, y la cooperación con el equipo fue crucial para integrar esta funcionalidad de manera fluida.<br><br>- **Paolo Del Carmen Martinez Villanueva:**<br> Me especialicé en la implementación de los módulos de análisis de datos y generación de informes. Esto permitió a los usuarios visualizar estadísticas clave y realizar un seguimiento del rendimiento. La comunicación constante con el equipo de frontend fue vital para asegurar que los datos se presentaran de manera clara y útil.<br><br>- **Michael Stefano Carmelino Dueñas:**<br> Trabajé en el desarrollo de la interfaz de usuario, asegurando que fuera intuitiva y accesible. Implementé diversas pruebas de usabilidad y ajusté el diseño basado en el feedback recibido. Colaborar estrechamente con los desarrolladores de backend fue crucial para garantizar que la integración fuera perfecta y que la experiencia del usuario fuera coherente y fluida. | **TB1:**<br><br>Durante el desarrollo del proyecto, nuestro equipo demostró habilidades de colaboración multidisciplinaria al integrar eficazmente conocimientos y habilidades de diferentes áreas, como desarrollo de software, diseño de interfaces de usuario y gestión de proyectos. Cada miembro del equipo contribuyó de manera eficiente a la consecución de los objetivos establecidos, cumpliendo con las tareas asignadas en los plazos definidos y manteniendo una comunicación abierta y efectiva. Además, se evidenció un enfoque objetivo en la toma de decisiones, priorizando el éxito del proyecto sobre intereses personales o conflictos internos. Estas experiencias fortalecieron la capacidad del equipo para trabajar conjuntamente en proyectos de ingeniería de software, promoviendo un ambiente de colaboración, eficiencia y objetividad.<br><br>**TP:**<br><br>Como conclusión para esta segunda entrega del proyecto, hemos promovido la comunicación oral grupal ya que al ser un trabajo de mayor complejidad, la comunicación ha sido necesaria para apoyarnos entre nosotros en nuestras tareas semanales. Al participar activamente en las llamadas grupales, hemos reconocido los conocimientos que tiene cada integrante. Además, estas interacciones nos han permitido resolver las dudas de cada integrante y compartir nuestros aprendizajes.<br><br>**TB2:**<br><br>En esta segunda entrega del proyecto (TB2), centrada en el desarrollo del backend, hemos promovido la colaboración efectiva en equipos multidisciplinarios. La complejidad del trabajo requirió una comunicación constante y eficiente, permitiéndonos apoyarnos mutuamente en nuestras tareas semanales. A través de reuniones grupales, hemos podido reconocer y aprovechar los conocimientos específicos de cada integrante, lo que ha resultado en un trabajo más coordinado y objetivo. Estas interacciones nos han permitido resolver dudas de manera rápida y compartir aprendizajes, mejorando la eficacia y eficiencia de nuestro equipo.<br><br> **TF:**<br><br>En esta entrega final del proyecto, hemos completado tanto el desarrollo del backend como del frontend y hemos logrado conectar ambos de manera efectiva. Durante esta fase, la colaboración en equipos multidisciplinarios ha sido clave para nuestro éxito. La complejidad del trabajo nos ha exigido mantener una comunicación constante y eficiente, lo que nos ha permitido apoyarnos mutuamente en nuestras tareas semanales. A través de reuniones grupales, hemos podido reconocer y aprovechar los conocimientos específicos de cada integrante, resultando en un trabajo más coordinado y objetivo. Estas interacciones han sido fundamentales para resolver dudas de manera rápida y compartir aprendizajes, mejorando la eficacia y eficiencia de nuestro equipo.<br><br>Hemos diseñado e implementado una API robusta, asegurando que todas las funcionalidades requeridas estén disponibles y operen de manera eficiente. Además, se han integrado medidas de seguridad, incluyendo autenticación y autorización, para proteger lsdatos y garantizar que solo los usuarios autorizados tengan acceso a la información. La base de datos ha sido estructurada y optimizada para manejar de manera eficiente las consultas y la persistencia de datos.<br><br>En cuanto al desarrollo del frontend, se ha diseñado una interfaz de usuario intuitiva y atractiva, enfocada en mejorar la experiencia del usuario final. El frontend se ha conectado con la API del backend, permitiendo una interacción fluida y en tiempo real entre el usuario y el sistema. También se han realizado pruebas de usuario para identificar y corregir posibles problemas de usabilidad, asegurando que la aplicación sea accesible y fácil de usar.<br><br>Hemos implementado mecanismos de comunicación eficientes entre el frontend y el backend, utilizando tecnologías como RESTful APIs y WebSockets para garantizar la sincronización de datos en tiempo real. Además, se han optimizado las llamadas a la API y la carga de datos para minimizar el tiempo de respuesta y mejorar el rendimiento general de la aplicación. |
| Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería. | **TB1:**<br><br>- **Francis Daniel Mamani Silva:**<br>Realización del capítulo 2, realización del landing page de nuestro proyecto, implementación de estilos en el landing page. Además, realicé entrevistas a los usuarios para conocer sus opiniones y recomendaciones acerca del proyecto.<br><br>- **Ian Macavilca Quispe:**<br>Me mantuve activo en la participación y comunicación oral en las llamadas grupales, dando ideas de mejora y ayuda tanto para el informe como para la Landing Page. Además, realicé entrevistas a los usuarios para conocer sus opiniones y recomendaciones acerca del proyecto.<br><br>- **Frank Junior Salazar Saldarriaga:**<br>Para esta entrega comuniqué mis ideas y propuse nuevas soluciones en las llamadas grupales, además de participar activamente en estas. Además, realicé entrevistas a los usuarios para conocer sus opiniones y recomendaciones acerca del proyecto.<br><br>- **Paolo Del Carmen Martinez Villanueva:**<br>Comuniqué mi idea para la elección del tema de nuestro proyecto durante la primera reunión del grupo y aporté ideas para poder realizar el trabajo de manera correcta. Además, realicé entrevistas a los usuarios para conocer sus opiniones y recomendaciones acerca del proyecto.<br><br>- **Michael Stefano Carmelino Dueñas:**<br>Participé en las llamadas grupales de cada semana pidiendo opiniones y nuevas ideas de implementación para la Landing Page. Además, realicé entrevistas a los usuarios para conocer sus opiniones y recomendaciones acerca del proyecto.<br><br>**TP:**<br><br>- **Francis Daniel Mamani Silva:**<br>Para esta entrega informé al grupo sobre mis avances en la aplicación web y estuve presente en las llamadas grupales.<br><br>- **Ian Macavilca Quispe:**<br>Para esta entrega estuve presente en las llamadas grupales para comunicar mis dudas y avances sobre el desarrollo de la aplicación web.<br><br>- **Frank Junior Salazar Saldarriaga:**<br>Para esta entrega estuve presente en las llamadas grupales para comunicar mis dudas y avances sobre el desarrollo de la aplicación web.<br><br>- **Paolo Del Carmen Martinez Villanueva:**<br>Para esta entrega realicé llamadas grupales continuamente para que los integrantes se repartieran tareas semanales y se ayuden entre ellos.<br><br>- **Michael Stefano Carmelino Dueñas:**<br>En esta entrega colaboré activamente en las llamadas grupales y comuniqué sobre mis avances y correcciones.<br><br>**TB2:**<br><br>- **Francis Daniel Mamani Silva:**<br>Documenté el proceso y los resultados de la gestión de cuentas de usuario de manera clara, asegurando la comprensión de todos los miembros del equipo.<br><br>- **Ian Macavilca Quispe:**<br>Elaboré la documentación sobre la validación de datos, explicando los mecanismos de manera estructurada para facilitar la revisión y la integración.<br><br>- **Frank Junior Salazar Saldarriaga:**<br>Preparé informes sobre el sistema de alertas de disponibilidad, proporcionando una comprensión clara tanto a desarrolladores como a usuarios.<br><br>- **Paolo Del Carmen Martinez Villanueva:**<br>Documenté los endpoints de gestión de roles y permisos, asegurando claridad y accesibilidad para todos los niveles jerárquicos.<br><br>- **Michael Stefano Carmelino Dueñas:** <br> Redacté sobre el sistema de inicio de sesión seguro, explicando las medidas de seguridad y su importancia. <br><br>**TF:**<br><br>- **Francis Daniel Mamani Silva:**<br>Elaboré un informe detallado sobre la gestión de cuentas de usuario, asegurando que cada aspecto del proceso fuera comunicado de manera clara y precisa. Esto facilitó la comprensión tanto para los desarrolladores como para los directores del proyecto, asegurando una implementación eficiente.<br><br>- **Ian Macavilca Quispe:**<br> Documenté exhaustivamente los mecanismos de validación de datos, presentando la información de manera estructurada y accesible. Este enfoque permitió una revisión efectiva por parte de especialistas en calidad y aseguró la integración fluida en el sistema final.<br><br>- **Frank Junior Salazar Saldarriaga:**<br> Preparé informes detallados sobre el sistema de alertas de disponibilidad, explicando sus funciones de manera clara para desarrolladores y usuarios finales por igual. Esta documentación fue esencial para garantizar una comunicación efectiva y una implementación sin contratiempos.<br><br>- **Paolo Del Carmen Martinez Villanueva:**<br> Documenté con precisión los endpoints de gestión de roles y permisos, asegurando que la información fuera comprensible para todos los niveles dentro del equipo. Esto facilitó una correcta implementación y mantenimiento del control de accesos en el sistema.<br><br>- **Michael Stefano Carmelino Dueñas:**<br> Redacté sobre el sistema de inicio de sesión seguro, destacando las medidas de seguridad implementadas y su relevancia. Esta comunicación fue crucial para transmitir la importancia de la protección de datos a los stakeholders y garantizar la confianza en el sistema de autenticación. |<br><br>**TB1:**<br><br>Durante la ejecución del proyecto, nuestro equipo demostró habilidades destacadas en la comunicación escrita objetiva al redactar documentos claros y concisos que transmitían ideas y resultados de manera efectiva. Además, se observó una adaptabilidad impresionante en la comunicación, ya que el equipo pudo ajustar el tono y el nivel de detalle de los documentos según la audiencia, incluyendo tanto a especialistas técnicos como a stakeholders de niveles jerárquicos superiores. La claridad y precisión en la redacción se mantuvieron constantes a lo largo del proyecto, lo que facilitó la comprensión de la información y evitó malentendidos. Estas habilidades de comunicación fortalecieron la colaboración dentro del equipo y contribuyeron al éxito general del proyecto en ingeniería.<br><br>**TP:**<br><br>Como conclusión para esta segunda entrega del proyecto, hemos promovido la comunicación oral grupal ya que al ser un trabajo de mayor complejidad, la comunicación ha sido necesaria para apoyarnos entre nosotros en nuestras tareas semanales. Al participar activamente en las llamadas grupales, hemos reconocido los conocimientos que tiene cada integrante. Además, estas interacciones nos han permitido resolver las dudas de cada integrante y compartir nuestros aprendizajes.<br><br>**TB2:**<br><br>En el marco del desarrollo del backend para esta entrega, hemos puesto un énfasis especial en la comunicación escrita. Nos hemos asegurado de transmitir ideas y resultados de manera clara y objetiva a públicos de diferentes especialidades y niveles jerárquicos. Esta habilidad ha sido crucial para documentar nuestros avances y asegurarnos de que todos los miembros del equipo, así como los interesados externos, comprendan plenamente el estado y los logros del proyecto. La práctica de comunicar de manera precisa y profesional ha fortalecido nuestra capacidad para trabajar de manera efectiva en un entorno multidisciplinario. <br><br>**TF:**<br><br>En esta entrega final del proyecto, hemos completado tanto el desarrollo del backend como del frontend y hemos logrado conectar ambos de manera efectiva. Durante esta fase, la colaboración en equipos multidisciplinarios ha sido fundamental para nuestro éxito. La complejidad del trabajo nos ha exigido mantener una comunicación constante y eficiente, lo que nos ha permitido apoyarnos mutuamente en nuestras tareas semanales. A través de reuniones grupales, hemos podido reconocer y aprovechar los conocimientos específicos de cada integrante, resultando en un trabajo más coordinado y objetivo. Estas interacciones han sido clave para resolver dudas de manera rápida y compartir aprendizajes, mejorando la eficacia y eficiencia de nuestro equipo.<br><br>En cuanto al desarrollo del backend, hemos diseñado e implementado una API robusta que asegura la disponibilidad y eficiencia de todas las funcionalidades requeridas. Se han integrado medidas de seguridad, incluyendo autenticación y autorización, para proteger los datos y garantizar que solo los usuarios autorizados tengan acceso a la información. La base de datos ha sido estructurada y optimizada para manejar de manera eficiente las consultas y la persistencia de datos.<br><br>Para el desarrollo del frontend, se ha diseñado una interfaz de usuario intuitiva y atractiva, enfocada en mejorar la experiencia del usuario final. El frontend se ha conectado con la API del backend, permitiendo una interacción fluida y en tiempo real entre el usuario y el sistema. También se han realizado pruebas de usuario para identificar y corregir posibles problemas de usabilidad, asegurando que la aplicación sea accesible y fácil de usar.|
...
| :- | :- | :- | :- |
|**EP01**|Autenticación de usuario|<p>**Como** usuario</p><p>**Quiero** registrarme e iniciar sesión</p><p>**Para** acceder a la aplicación PetPal</p>|<p>US01 - Registro de usuario</p><p></p><p>US02 - Inicio de sesión</p>|
|**EP02**|Gestión de cuentas|<p>**Como** usuario</p><p>**Quiero** administrar y personalizar mi cuenta</p><p>**Para** poder realizar cambios en mi cuenta</p>|<p>US03 - Recuperación de contraseña</p><p></p><p>US04 - Cambiar dirección de correo electrónico</p><p></p><p>US05 - Eliminar Cuenta</p>|
|**EP03**|Perfil de mascotas|<p>**Como** usuario</p><p>**Quiero** crear un perfil para cada una de mis mascotas</p><p>**Para** poder mantener un registro detallado</p>|<p>US06 - Visualización del perfil de mascota</p><p></p><p>US07 - Edición del perfil de mascota</p><p></p><p>US08 - Eliminación del perfil de mascota</p>|
|**EP04**|Gestión de citas veterinarias|<p>**Como** usuario</p><p>**Quiero** programar citas veterinarias</p><p>**Para** garantizar su bienestar y salud</p>|<p>US10 - Programación de cita veterinaria</p><p></p><p>US11 - Historial de citas veterinarias</p><p></p><p>US12 - Cancelación de cita veterinaria</p>|
|**EP05**|Gestión de dieta|<p>**Como usuario**</p><p>**Quiero poder gestionar la dieta de mi mascota**</p><p>**Para garantizar su buena alimentación**</p>|US09 - Registro de dieta diaria|
|**EP06**|Acceso a consejos|<p>**Como** usuario</p><p>**Quiero** acceder a una sección de consejos</p><p>**Para** mejorar el cuidado de mis mascotas</p>|US13 - Visualización de consejos|
...
|**US15**|Agregar descripción de mascota|<p>**Como** usuario</p><p>**Quiero** agregar una descripción de mi mascota</p><p>**Para** registrarla como información relevante de mi mascota</p>|<p>**Escenario 1: Agregar información general**</p><p></p><p>**Dado que** el usuario está en la sección del perfil</p><p>**Cuando** seleccione el botón “Registrar mascota”</p><p>**Entonces** podrá escribir todas las características de su mascota</p><p></p><p>**Escenario 2: Agregar descripción**</p><p>** </p><p>**Dado que** el usuario está en la sección del perfil</p><p>**Cuando** registre a su nueva mascota</p><p>**Entonces** podrá añadir una descripción de su mascota</p>|EP07|
|**US16**|Registro de tratamientos|<p>**Como** usuario</p><p>**Quiero** registrar los tratamientos administrados a mi mascota</p><p>**Para** garantizar que recibe el cuidado necesario</p>|<p>**Escenario 1: Registro de tratamientos**</p><p></p><p>**Dado que** el usuario está en la página de registro de tratamiento</p><p>**Cuando** ingrese los detalles del tratamiento administrado a su mascota</p><p>**Entonces** se registrará correctamente en el sistema</p><p></p><p>**Escenario 2: Registro incorrecto**</p><p></p><p>**Dado que** el usuario está en la página de registro de tratamiento</p><p>**Cuando** ingrese los detalles del tratamiento administrado a su mascota</p><p>**Y** olvide llenar un campo</p><p>**Entonces** se mostrará un mensaje de error</p><p>**Y** no se creará el registro</p>|EP8|
|**US17**|Recordatorio de tratamientos|<p>**Como** usuario</p><p>**Quiero** recibir recordatorios para la administración de medicamentos</p><p>**Para** asegurarme que mi mascota siga su tratamiento correctamente</p>|<p>**Escenario 1: Crear recordatorio**</p><p></p><p>**Dado que** el usuario se encuentra en la sección de tratamientos</p><p>**Cuando** ingrese los detalles del tratamiento y su programación de dosificación</p><p>**Entonces** el sistema generará automáticamente un recordatorio de administración según la frecuencia y el horario establecido</p><p></p><p>**Escenario 2: Recordatorio incorrecto**</p><p></p><p>**Dado que** el usuario se encuentra en la sección de tratamientos</p><p>**Cuando** ingrese los detalles del tratamiento</p><p>**Y** olvide llenar un campo</p><p>**Entonces** se mostrará un mensaje de error</p><p>**Y** no se creará el recordatorio</p>|EP8|
|**US18**|Historial médico|<p>**Como** usuario</p><p>**Quiero** ver el historial médico de mi mascota</p><p>**Para** tener un registro detallado de su salud</p>|<p>**Escenario 1: Visualización de historial médico**</p><p></p><p>**Dado que** el usuario está en la página de historial médico</p><p>**Cuando** seleccione la mascota específica</p><p>**Entonces** podrá ver una lista de todos los tratamientos administrados a su mascota</p><p></p><p>**Escenario 2: Ver detalles** </p><p></p><p>**Dado que** el usuario desea ver detalles sobre un tratamiento</p><p>**Cuando** haga clic en el tratamiento deseado</p><p>**Entonces** podrá ver información detallada sobre el tratamiento seleccionado</p>|EP8|
|**US19**|Contactar al soporte|<p>**Como** usuario</p><p>**Quiero** poder contactar al equipo de soporte de la aplicación</p><p>**Para** obtener ayuda con problemas técnicos</p>|<p>**Escenario 1: Envío de consulta**</p><p>** </p><p>**Dado que** el usuario tiene una pregunta sobre el funcionamiento de la aplicación o desea realizar un reclamo</p><p>**Cuando** acceda a la sección de soporte</p><p>**Y** complete el formulario de contacto</p><p>**Entonces** podrá enviar su consulta al soporte</p><p>** </p><p>**Escenario 2: Respuesta del soporte**</p><p>** </p><p>**Dado que** el usuario ha enviado una consulta al soporte</p><p>**Cuando** reciba una respuesta</p><p>**Entonces** podrá recibir asistencia a su problema</p>|EP09|
|**US20**|Dar feedback|<p>**Como** usuario</p><p>**Quiero** poder proporcionar feedback sobre la aplicación</p><p>**Para** compartir sugerencias o comentarios que ayuden a mejorar la experiencia del usuario</p>|<p>**Escenario 1: Compartir sugerencias**</p><p>** </p><p>**Dado que** el usuario tiene una idea para mejorar la aplicación</p><p>**Cuando** acceda a la sección de contacto</p><p>**Entonces** podrá enviar un correo al equipo de desarrollo para poder mejorar la aplicación</p>|EP09|
|**US21**|Acceder desde cualquier dispositivo a la landing page|<p>**Como** visitante del landing page</p><p>**Quiero** poder acceder al sitio web desde diferentes dispositivos</p><p>**Para** poder ingresar al sitio web desde cualquier dispositivo</p>|<p>**Escenario 1:** Accesibilidad desde diferentes dispositivos</p><p></p><p>**Dado que** el usuario es un visitante del landing page</p><p>**Cuando** acceda al sitio web desde un dispositivo diferente (móvil, tablet, PC)</p><p>**Entonces** debería poder visualizar la página correctamente en cualquier dispositivo</p><p></p><p>**Escenario 2:** Acceso fácil desde cualquier lugar</p><p></p><p>**Dado que** el usuario es un visitante del landing page</p><p>**Cuando** intente acceder al sitio web desde mi dispositivo habitual</p><p>**Entonces** debería poder ingresar a la página de PetPal desde cualquier lugar y dispositivo</p>|EP07|
|**US22**|Sección “Servicios”|<p>**Como** visitante del landing page</p><p>**Quiero** conocer sobre los servicios que brinda la aplicación</p><p>**Para** informarme sobre su uso</p>|<p>**Escenario 1: Visualización de los features**</p><p>** </p><p>**Dado que** el usuario se encuentra en el landing page </p><p>**Cuando** acceda a la sección “Servicios”</p><p>**Entonces** podrá visualizar los servicios que brinda la aplicación</p><p></p><p>**Escenario 2:** **Sección no atractiva**</p><p></p><p>**Dado que** el usuario está ingresando a la página de inicio desde otro dispositivo</p><p>**Cuando** revise la información y la encuentre desordenada y desagradable a la vista</p><p>**Entonces** cierra nuestra página y continúa navegando por internet</p><p>** </p>|EP10|
|**US23**|Sección “Recursos”|<p>**Como** visitante del landing page</p><p>**Quiero** poder acceder a la sección “Recursos”</p><p>**Para** obtener información sobre los recursos que brinda PetPal</p>|<p>**Escenario 1: Acceso a la sección “Recursos”**</p><p>** </p><p>**Dado que** el usuario está explorando el landing page</p><p>**Cuando** acceda a la sección “Recursos”</p><p>**Entonces** podrá leer sobre los recursos que brinda la aplicación</p><p></p><p>**Escenario 2:** **Sección no atractiva**</p><p></p><p>**Dado que** el usuario está ingresando a la página de inicio desde otro dispositivo</p><p>**Cuando** revise la información y la encuentre desordenada y desagradable a la vista</p><p>**Entonces** cierra nuestra página y continúa navegando por internet</p>|EP10|
|**US24**|Sección “Testimonios”|<p>**Como** visitante del landing page</p><p>**Quiero** poder acceder a la sección “Testimonios”</p><p>**Para** leer opiniones sobre usuarios de PetPal</p>|<p>**Escenario 1: Acceso a la sección “Testimonios”**</p><p>** </p><p>**Dado que** el usuario está explorando el landing page</p><p>**Cuando** acceda a la sección “Testimonios”</p><p>**Entonces** podrá leer testimonios de usuarios de PetPal</p><p></p><p>**Escenario 2:** **Sección no atractiva**</p><p></p><p>**Dado que** el usuario está ingresando a la página de inicio desde otro dispositivo</p><p>**Cuando** revise la información y la encuentre desordenada y desagradable a la vista</p><p>**Entonces** cierra nuestra página y continúa navegando por internet</p>|EP10|
|**US25**|Sección “Nosotros”|<p>**Como** visitante del landing page</p><p>**Quiero** poder acceder a la sección “Nosotros”</p><p>**Para** conocer al equipo de PetPal</p>|<p>**Escenario 1: Acceso a la sección “Nosotros”**</p><p>** </p><p>**Dado que** el usuario está explorando el landing page</p><p>**Cuando ac**ceda a la sección “Nosotros”</p><p>**Entonces** podrá conocer y leer acerca del equipo de PetPal</p><p></p><p>**Escenario 2:** **Sección no atractiva**</p><p></p><p>**Dado que** el usuario está ingresando a la página de inicio desde otro dispositivo</p><p>**Cuando** revise la información y la encuentre desordenada y desagradable a la vista</p><p>**Entonces** cierra nuestra página y continúa navegando por internet</p>|EP10|
...
| :- | :- | :- | :- | :- |
|1|**US06**|Visualización de perfil de mascota|<p>**Como** usuario</p><p>**Quiero** poder ver el perfil completo de cada una de mis mascotas</p><p>**Para** acceder a su información detallada y necesidades individuales</p>|<p></p><p>3</p>|
|2|**US07**|Edición del perfil de mascota|<p>**Como** usuario</p><p>**Quiero** poder editar la información de mi mascota en su perfil</p><p>**Para** mantenerla actualizada</p>|<p></p><p>3</p>|
|3|**US08**|Eliminación del perfil de mascota|<p>**Como** usuario</p><p>**Quiero** quiero poder eliminar un perfil de mascota</p><p>**Para** actualizar mis perfiles si es necesario</p>|<p></p><p>3</p>|
|4|**US9**|Registro de dieta diaria|<p>**Como** usuario</p><p>**Quiero** poder registrar la dieta diaria de mis mascotas</p><p>**Para** asegurarme que reciben la nutrición adecuada</p>|<p></p><p>8</p>|
|5|**US10**|Programación de cita veterinaria|<p>**Como** usuario</p><p>**Quiero** programar una cita veterinaria para mi mascota</p><p>**Para** garantizar su salud y bienestar</p>|<p></p><p>8</p>|
|6|**US11**|Historial de citas veterinarias|<p>**Como** usuario</p><p>**Quiero** ver el historial completo de citas veterinarias de mis mascotas</p><p>**Para** tener un registro de su atención médica</p>|<p></p><p>5</p>|
|7|**US12**|Cancelación de cita veterinaria|<p>**Como** usuario</p><p>**Quiero** cancelar una cita veterinaria</p><p>**Para** actualizar si es necesario</p>|<p></p><p>5</p>|
|8|**US13**|Búsqueda de consejos |<p>**Como** usuario</p><p>**Quiero** buscar consejos específicos</p><p>**Para** encontrar información más rápidamente</p>|<p></p><p>5</p>|
|9|**US14**|Agregar foto de perfil a la mascota|<p>**Como** usuario</p><p>**Quiero** poder agregar una foto al perfil de mi mascota</p><p>**Para** personalizarlo y hacerlo más identificable</p>|<p></p><p>3</p>|
|10|**US15**|Agregar descripción de mascota|<p>**Como** usuario</p><p>**Quiero** agregar una descripción de mi mascota</p><p>**Para** registrarla como información relevante de mi mascota</p>|<p></p><p>3</p>|
|11|**US16**|Registro de tratamientos|<p>**Como** usuario</p><p>**Quiero** registrar los tratamientos administrados a mi mascota</p><p>**Para** garantizar que recibe el cuidado necesario</p>|<p></p><p>8</p>|
|12|**US17**|Recordatorio de tratamientos|<p>**Como** usuario</p><p>**Quiero** recibir recordatorios para la administración de medicamentos</p><p>**Para** asegurarme que mi mascota siga su tratamiento correctamente</p>|<p></p><p>5</p>|
|13|**US18**|Historial médico|<p>**Como** usuario</p><p>**Quiero** ver el historial médico de mi mascota</p><p>**Para** tener un registro detallado de su salud</p>|<p></p><p>5</p>|
|14|**US21**|Acceder desde cualquier dispositivo a la landing page|<p>**Como** visitante del landing page</p><p>**Quiero** que sea accesible desde diferentes dispositivos </p><p>**Para** poder ingresar al sitio web desde cualquier dispositivo</p>|<p></p><p>3</p>|
|15|**US22**|Sección “Servicios”|<p>**Como** visitante del landing page</p><p>**Quiero** conocer sobre los servicios que brinda la aplicación</p><p>**Para** informarme sobre su uso</p>|<p></p><p>3</p>|
|16|**US23**|Sección “Recursos”|<p>**Como** visitante del landing page</p><p>**Quiero** poder acceder a la sección “Recursos”</p><p>**Para** obtener información sobre los recursos que brinda PetPal</p>|<p></p><p>3</p>|
|21|**US24**|Sección “Testimonios”|<p>**Como** visitante del landing page</p><p>**Quiero** poder acceder a la sección “Testimonios”</p><p>**Para** leer opiniones sobre usuarios de PetPal</p>|<p></p><p>3</p>|
|17|**US25**|Sección “Nosotros”|<p>**Como** visitante del landing page</p><p>**Quiero** poder acceder a la sección “Nosotros”</p><p>**Para** conocer al equipo de PetPal</p>|<p></p><p>3</p>|
|18|**US19**|Contactar al soporte|<p>**Como** usuario</p><p>**Quiero** poder contactar al equipo de soporte de la aplicación</p><p>**Para** obtener ayuda con problemas técnicos</p>|<p></p><p>3</p>|
|19|**US20**|Dar feedback|<p>**Como** usuario</p><p>**Quiero** poder proporcionar feedback sobre la aplicación</p><p>**Para** compartir sugerencias o comentarios que ayuden a mejorar la experiencia del usuario</p>|2|
|20|**US01**|Registro de usuario|<p>**Como** usuario nuevo</p><p>**Quiero** poder registrarme en PetPal</p><p>**Para** poder acceder a todas las funcionalidades de la aplicación</p>|<p></p><p>1</p>|
|21|**US02**|Inicio de sesión|<p>**Como** usuario registrado</p><p>**Quiero** poder iniciar sesión en la aplicación</p><p>**Para** acceder a mi cuenta</p>|<p></p><p>1</p>|
|22|**US03**|Recuperación de contraseña|<p>**Como** usuario registrado</p><p>**Quiero** tener la opción de recuperación de contraseña</p><p>**Para** poder acceder a mi cuenta sin problemas</p>|<p></p><p>1</p>|
|23|**US04**|Cambiar dirección de correo electrónico|<p>**Como** usuario</p><p>**Quiero** poder cambiar la dirección de correo electrónico asociada a mi cuenta</p><p>**Para** mantener mi información de contacto actualizada</p>|<p></p><p>1</p>|
|24|**US05**|Eliminar cuenta|<p>**Como** usuario</p><p>**Quiero** tener la opción de eliminar permanentemente mi cuenta y todos los datos asociados</p><p>**Para** borrar la información de mi cuenta de la aplicación</p>|<p></p><p>1</p>|
|25|**TS01**|**Post User**|<p>**Como** desarrollador que trabaja en la aplicación de PetPal</p><p>**Quiero** registrar a un nuevo usuario mediante una API</p><p>**Para** que esté disponible para crear funcionalidades en mi aplicación</p>|<p></p><p>3</p>|
|26|**TS02**|**Get User**|<p>**Como** desarrollador que trabaja en la aplicación de PetPal</p><p>**Quiero** obtener la información de un usuario mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>3</p>|
|27|**TS03**|**Post Pet**|<p>**Como** desarrollador que trabaja en la aplicación de PetPal</p><p>**Quiero** registrar una nueva mascota mediante una API</p><p>**Para** que esté disponible para crear funcionalidades en mi aplicación</p>|<p></p><p>5</p>|
|28|**TS04**|**Get Pet**|<p>**Como** desarrollador que trabaja en la aplicación de PetPal</p><p>**Quiero** obtener la información de una mascota mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>5</p>|
...
4\.1.1. General Style Guidelines.
  ...
  **Tono de Comunicación y lenguaje aplicado:** Entendemos que brindar el mejor cuidado a tus mascotas es un viaje que requiere dedicación y compromiso. En nuestra plataforma, nos esforzamos por acompañarte en cada paso de este camino. Nuestro tono de comunicación y lenguaje se distingue por ser respetuoso y entusiasta, alentandote a cuidar de tus fieles compañeros con amor y dedicación. Así como la UPC  inspira a sus estudiantes a alcanzar sus metas, nosotros te motivamos a dar lo mejor para el bienestar de tus mascotas.
...
<p align="center">
        <img src="https://github.com/PetPalORG/PetPal-Informe/assets/164519824/cef2d255-8c1b-4e7d-aa07-87e6206ea44f" alt="image">
    </p>
...
<p align="center">
        <img src="https://github.com/PetPalORG/PetPal-Informe/assets/164519824/8b6ef292-3604-4aab-8b15-5ddf66c7284b" alt="image">
    </p>
...
<p align="center">
        <img src="https://github.com/PetPalORG/PetPal-Informe/assets/164519824/0de165de-f5e8-4ff8-b297-d24d0513270d" alt="image">
    </p>
...
<p align="center">
        <img src="https://github.com/PetPalORG/PetPal-Informe/assets/164519824/8d5da883-03b2-49f2-af7e-31780e7d4d42" alt="image">
    </p>
...
<p align="center">
        <img src="https://github.com/PetPalORG/PetPal-Informe/assets/164519824/26b76663-654c-4828-aafd-a7a5eb492805" alt="image">
    </p>

**CSS:** CSS (Cascading Style Sheets) es un lenguaje de diseño utilizado para estilizar la presentación de documentos HTML.

<p align="center">
        <img src="https://github.com/PetPalORG/PetPal-Informe/assets/164519824/273e106c-46ef-4800-9546-269b05e7ab4c" alt="image">
    </p>
...
<p align="center">
        <img src="https://github.com/PetPalORG/PetPal-Informe/assets/164519824/f3d939b6-a477-48ac-9242-5ce59680f75e" alt="image">
    </p>
...
| US21 | Acceder desde cualquier dispositivo a la landing page | W-05 | Accesibilidad | <p>**Como** visitante del landing page</p><p>**Quiero** que sea accesible desde diferentes dispositivos </p><p>**Para** poder ingresar al sitio web desde cualquier dispositivo</p> | 3 hours | **Frank Junior Salazar Saldarriaga** | Done |
| US22 | Sección “Servicios” | W-02 | Sección “Servicios**”** | <p>**Como** visitante del landing page</p><p>**Quiero** conocer sobre los servicios que brinda la aplicación</p><p>**Para** informarme sobre su uso</p> | 3 hours | **Francis Daniel Mamani Silva** | Done |
| US23 | Sección “Recursos” | W-03 | Sección “Recursos” | <p>**Como** visitante del landing page</p><p>**Quiero** poder acceder a la sección “Recursos”</p><p>**Para** obtener información sobre los recursos que brinda PetPal</p> | 3 hours | **Ian Macavilca Quispe** | Done |
| US24 | Sección “Testimonios” | W-04 | Sección “Testimonios” | <p>**Como** visitante del landing page</p><p>**Quiero** poder acceder a la sección “Comunidad”</p><p>**Para** conocer a la comunidad de PetPal</p> | 3 hours | **Paolo Del Carmen Martines Villanueva** | Done |
| US25 | Sección “Nosotros” | W-04 | Sección “Nosotros” | <p>**Como** visitante del landing page</p><p>**Quiero** poder acceder a la sección “Nosotros”</p><p>**Para** conocer al equipo de PetPal</p> | 3 hours | **Michael Stefano Carmelino Dueñas** | Done |
...
|US03|Recuperación de contraseña|W-03|Opción Recuperar Contraseña|<p>**Como** usuario registrado</p><p>**Quiero** tener la opción de recuperación de contraseña</p><p>**Para** poder acceder a mi cuenta sin problemas</p>|1 hours|**Francis Daniel Mamani Silva**|In progress|
|US04|Cambiar dirección de correo electrónico|W-04|Opción Cambiar Correo|<p>**Como** usuario</p><p>**Quiero** poder cambiar la dirección de correo electrónico asociada a mi cuenta</p><p>**Para** mantener mi información de contacto actualizada</p>|2 hours|**Francis Daniel Mamani Silva**|Done|
|US06|Visualización de perfil de mascota|W-05|Perfil de mascotas|<p>**Como** usuario</p><p>**Quiero** poder ver el perfil completo de cada una de mis mascotas</p><p>**Para** acceder a su información detallada y necesidades individuales</p>|4 hours|**Paolo Del Carmen Martinez Villanueva**|Done|
|US07|Edición del perfil de mascota|W-06|Edición de perfil|<p>**Como** usuario</p><p>**Quiero** poder editar la información de mi mascota en su perfil</p><p>**Para** mantenerla actualizada</p>|4 hours|**Paolo Del Carmen Martinez Villanueva**|Done|
|US08|Eliminación del perfil de mascota|W-07|Eliminar perfil|<p>**Como** usuario</p><p>**Quiero** quiero poder eliminar un perfil de mascota</p><p>**Para** actualizar mis perfiles si es necesario</p>|4 hours|**Paolo Del Carmen Martinez Villanueva**|Done|
|US09|Registro de dieta diaria|W-08|Registro de dieta|<p>**Como** usuario</p><p>**Quiero** poder registrar la dieta diaria de mis mascotas</p><p>**Para** asegurarme que reciben la nutrición adecuada</p>|4 hours|**Paolo Del Carmen Martinez Villanueva**|Done|
|US10|Programación de cita veterinaria|W-09|Cita veterinaria|<p>**Como** usuario</p><p>**Quiero** programar una cita veterinaria para mi mascota</p><p>**Para** garantizar su salud y bienestar</p>|4 hours|**Paolo Del Carmen Martinez Villanueva**|Done|
...
|US12|Cancelación de cita veterinaria|W-11|Cancelar cita|<p>**Como** usuario</p><p>**Quiero** cancelar una cita veterinaria</p><p>**Para** actualizar si es necesario</p>|2 hours|**Paolo Del Carmen Martinez Villanueva**|Done|
...
|US14|Agregar foto de perfil a la mascota|W-13|Foto de mascota|<p>**Como** usuario</p><p>**Quiero** poder agregar una foto al perfil de mi mascota</p><p>**Para** personalizarlo y hacerlo más identificable</p>|2 hours|**Paolo Del Carmen Martinez Villanueva**|In-Process|
...
|US16|Registro de tratamientos|W-15|Registrar tratamientos|<p>**Como** usuario</p><p>**Quiero** registrar los tratamientos administrados a mi mascota</p><p>**Para** garantizar que recibe el cuidado necesario</p>|4 hours|**Paolo Del Carmen Martinez Villanueva**|Done|
...
|US17|Historial médico|W-17|Historial médico|<p>**Como** usuario</p><p>**Quiero** ver el historial médico de mi mascota</p><p>**Para** tener un registro detallado de su salud</p>|4 hours|**Paolo Del Carmen Martinez Villanueva**|Done|
|US05|Eliminar cuenta|W-18|Eliminación de cuenta|<p>**Como** usuario</p><p>**Quiero** tener la opción de eliminar permanentemente mi cuenta y todos los datos asociados</p><p>**Para** borrar la información de mi cuenta de la aplicación</p>|2 hours|**Michael Stefano Carmelino Dueñas**|In-Process|
...
2. **Registro de usuario**
   - Implementamos una pantalla de registro de usuario
     ...
     ![image](https://github.com/PetPalORG/PetPal-Informe/assets/164519824/ee2df1e3-8f13-47d9-a71b-968effebf7ce)
...
3. **Inicio de sesión**
   ...
   - Implementamos una pantalla de inicio sesión
    ...
    ![image](https://github.com/PetPalORG/PetPal-Informe/assets/164519824/9f287946-410f-4196-aaff-a8aacd932adf)
...
4. **Barra de Navegación (Navbar):**
   - Se creó y configuró una barra de navegación para permitir la navegación fácil entre las diferentes secciones de la página
    ...
    ![image](https://github.com/PetPalORG/PetPal-Informe/assets/164519824/41e1e833-0adc-4e54-89b7-afcc1c3c8ba1)
...
5. **Sección de Perfiles:**
   - Se diseño e implementamos una sección de perfiles que muestra el perfil de cada mascota
     ...
     ![image](https://github.com/PetPalORG/PetPal-Informe/assets/164519824/e3c683da-11db-4cb1-b9ec-55a5fdfb1d48)


6. **Seccion de agregar mascota :**
   - Se implementó una sección para poder ingresar una nueva mascota
     
    ![image](https://github.com/PetPalORG/PetPal-Informe/assets/164519824/02a9f053-0c7a-44b2-a084-957cdb3d7cb9)
...
7. **Seccion de dieta :**
   - Implementamos una sección para observar el registro de comidas de la mascota
     ...
     ![image](https://github.com/PetPalORG/PetPal-Informe/assets/164519824/7aa4b225-cc35-4563-b4ab-fa55addf5ff7)


8. **Sección de citas veterinarias:**
   - Implementamos una sección para llevar el registro de citas veterinarias de la mascota
      
     ![image](https://github.com/PetPalORG/PetPal-Informe/assets/164519824/8a3ec488-203e-458c-a6c3-07c391304ff3)
...
9. **Sección de tratamientos :**
   ...
   - Implementamos una sección de tratamientos para llevar el registro de tratamientos de la mascota
    ...
    ![image](https://github.com/PetPalORG/PetPal-Informe/assets/164519824/faf233e1-b1d4-41c3-a813-6d7bc92a2a70)
...
10. **Sección historial médico :**
   ...
   - Implementamos una sección de historial médico para guardar todas las citas y tratamientos pasados de nuestra mascota
      ...
      ![image](https://github.com/PetPalORG/PetPal-Informe/assets/164519824/771e33ba-6997-439f-8fd8-bd8b718c2340)


11. **Sección artículos :**
   - Implementamos una sección para buscar artículos relacionados a mascotas que sean útiles
          
     ![image](https://github.com/PetPalORG/PetPal-Informe/assets/164519824/2f1c0b66-c37e-456f-b5de-64310373084b)

12. **Detalle del artículo:**
   - Desarrollamos un apartado que muestre todos los detalles de los artículos buscados
   
     ![image](https://github.com/PetPalORG/PetPal-Informe/assets/164519824/9c31965c-b8bc-4a88-b809-03a52da15723)
...
![image](https://github.com/PetPalORG/PetPal-Informe/assets/164519824/c08daeb4-5a07-4e3d-9bd2-0ac2c991ae11)
...
|TS02|Get User|W-02|Implementación de obtención de Usuario|<p>**Como** usuario registrado</p><p>**Quiero** poder obtener mi información de usuario en PetPal</p><p>**Para** acceder fácilmente a mis datos personales en la aplicación</p>|2 hours|**Michael Stefano Carmelino Dueñas**|Done|
...
|TS06|Get Food By Pet|W-06|Implementación de obtención de comidas por mascota|<p>**Como** usuario</p><p>**Quiero** poder obtener las comidas registradas de mi mascota</p><p>**Para** llevar un registro de su alimentación</p>|4 hours|**Frank Junior Salazar Saldarriaga**|Done|
|TS08|Post Treatment|W-07|Implementación de tratamientos|<p>**Como** usuario</p><p>**Quiero** quiero registrar los tratamientos de mi mascota</p><p>**Para** tener un registro ordenado en la aplicación</p>|4 hours|**Paolo Del Carmen Martinez Villanueva**|Done|
...
- **Problema**:
  - Los usuarios se sienten confundidos al intentar agregar una nueva mascota a su perfil debido a la falta de claridad en las instrucciones o la falta de un flujo de registro intuitivo.
  - Esto limita la libertad y el control del usuario durante la interacción con la aplicación, lo que puede resultar en frustración y abandono.
- **Recomendación**:
  - Mejorar la claridad de las instrucciones y simplificar el flujo de registro de mascotas para que los usuarios puedan agregar fácilmente nuevas mascotas a sus perfiles sin confusiones.

### PROBLEMA #2: Desorganización de Campos en el Formulario de Registro de Mascotas
- **Severidad**: 2
- **Heurística Violada**: Usability - Consistencia y estándares
- **Problema**:
  - Los campos en el formulario de registro de mascotas no están organizados de manera lógica, lo que dificulta la navegación y comprensión para los usuarios, especialmente en dispositivos móviles.
  - Esta falta de consistencia en el diseño puede generar confusión y afectar negativamente la experiencia del usuario.
- **Recomendación**:
  - Reorganizar y estructurar los campos en el formulario de registro de mascotas de manera lógica y coherente, asegurando una experiencia de usuario más consistente y fácil de entender.

### PROBLEMA #3: Falta de Descripciones Alternativas en Imágenes de Mascotas
- **Severidad**: 3
- **Heurística Violada**: Inclusive Design - Proporciona experiencias comparables
- **Problema**:
  - Las imágenes de las mascotas en los perfiles carecen de descripciones alternativas (atributo "alt"), lo que excluye a usuarios con discapacidades visuales y no cumple con los estándares de accesibilidad.
  - Esto impide que algunos usuarios accedan a la información visual de las mascotas, afectando negativamente su experiencia en la aplicación.
- **Recomendación**:
...
- **Problema**:
  - La información sobre las necesidades específicas de salud y cuidado de las mascotas no está fácilmente accesible en los perfiles, lo que dificulta a los usuarios proporcionar el cuidado adecuado a sus mascotas.
  - Esta falta de información esencial puede resultar en un cuidado deficiente de las mascotas y en experiencias negativas para los usuarios.
- **Recomendación**:
...
- **Problema**:
  - Algunos usuarios se encuentran con problemas al intentar editar o eliminar información en los perfiles de mascotas debido a la falta de opciones claras de edición o eliminación.
  - Esta falta de control y libertad del usuario puede resultar en una experiencia frustrante y limitada en la aplicación.
- **Recomendación**:
...
- **Problema**:
  - La aplicación no ofrece orientación adecuada o tutoriales para los usuarios nuevos, lo que resulta en una curva de aprendizaje pronunciada y dificulta la adopción de la aplicación por parte de nuevos usuarios.
  - Esta falta de ayuda y documentación puede generar confusión y frustración en los usuarios nuevos, afectando su percepción sobre la utilidad de la aplicación.
- **Recomendación**:
...
En la fase final del proyecto , dedicada al desarrollo del backend, la colaboración y comunicación técnica efectiva se mantuvieron como pilares fundamentales. La necesidad de una comunicación constante y precisa fue aún más evidente, permitiendo la resolución rápida de problemas técnicos y la integración sin contratiempos de los diferentes módulos del sistema. La documentación detallada de los endpoints, la estructura de la base de datos y los procesos de autenticación y autorización aseguraron que todos los interesados comprendieran y valoraran adecuadamente los avances y resultados. Este enfoque consolidó el éxito del proyecto, destacando la importancia de la comunicación técnica clara y la colaboración en el desarrollo de sistemas backend complejos, y fortaleciendo nuestras competencias técnicas en un entorno multidisciplinario.
